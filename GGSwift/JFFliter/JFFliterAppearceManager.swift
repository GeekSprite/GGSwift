...
class JFFliterAppearceManager: NSObject {
    ...
    var subButtonBackgroundColor = UIColor.colorWithHexString(hex: "#323336")
    var subButtonTextNormalColor = UIColor.colorWithHexString(hex: "#D7D7D7")
    var subButtonTextChoodenColor = UIColor.colorWithHexString(hex: "#FF7700")
    ...
    var pickerContainerColor = UIColor.colorWithHexString(hex: "#030404")
    var pickerBackgroundColor = UIColor.colorWithHexString(hex: "#232529")
    var pickerTextColor = UIColor.colorWithHexString(hex: "#616161")
    var pickerPlaceHolderColor = UIColor.colorWithHexString(hex: "#4E4E4E")
    var pickerTextFont = UIFont.systemFont(ofSize: FontUtil.fontSize(size: 14))
    var pickerIndicaterColor = UIColor.colorWithHexString(hex: "#FFFFFF")
